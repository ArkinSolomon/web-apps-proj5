        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CurrentTermSeason = table.Column<int>(type: "int", nullable: false),
                    Name = table.Column<string>(type: "Varchar(33)", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsGenEd = table.Column<bool>(type: "tinyint(1)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    PlanName = table.Column<string>(type: "Varchar(32)", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    PlannerUserId = table.Column<string>(type: "varchar(255)", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Plans_AspNetUsers_PlannerUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CourseId = table.Column<string>(type: "Varchar(10)", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    TermSeason = table.Column<int>(type: "int", nullable: false),
                    Year = table.Column<short>(type: "Year", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PlannedCourses_Plans_PlanId",
                        column: x => x.PlanId,
                        principalTable: "Plans",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Requirements_AccomplishmentId",
                table: "Requirements",
                column: "AccomplishmentId");
